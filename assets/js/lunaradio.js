/*
 ...
 Copyright (C) CREATIVO AGENCIA | FRANCO ZAMORA
 https://www.creativoagencia.pe
...
if (w.metadatatechnic === "corsproxy") {
        ...
        function La() {
            d.ajax({
                ...
                method: "GET",
                crossDomain: !0,
                url: "https://argay.ddns.net/api/nowplaying/argay_radio" + Fb + "&apikey=" + Gb + "&callmeback=yes&type=xml&cover=yes&previous=yes",
                success: function(b) {
                    try {
        ...
        function Bb() {
            d.ajax({
                ...
                method: "GET",
                crossDomain: !0,
                url: "https://argay.ddns.net/api/nowplaying/argay_radio" + Hb + "/now_playing/?rand=" + Math.random(),
                success: function(b) {
                    try {
                        var a = JSON.parse(b);
        ...
        function Cb() {
            d.ajax({
                ...
                method: "GET",
                crossDomain: !0,
                url: "https://argay.ddns.net/api/nowplaying/argay_radio" + Ib + "/status",
                success: function(b) {
                    try {
                        var a = JSON.parse(b);
 ...
 function zeno() {
    zurl = "https://zenoplay.zenomedia.com/api/zenofm/nowplaying/yu61me5evq6uv/?rand="+ Math.random();
